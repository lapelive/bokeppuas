...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokeppuas.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "logo": "https://bokeppuas.pages.dev/favicon.ico",
        "url": "https://bokeppuas.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokeppuas.pages.dev"
        ...
        "url": "https://bokeppuas.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "image": "https://bokeppuas.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokeppuas.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokeppuas.pages.dev/?q={search_term}", 
